(function () {
  ...
  window.redux_promise_middleware = window.redux_promise_middleware || {};
  const exports = window.redux_promise_middleware;
  ...
  var _isPromise = window.redux_promise_middleware.isPromise;
