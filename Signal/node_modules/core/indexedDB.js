(function () {
    ...
    function IDBTransaction(db, storeName) {
        ...
        this.objectStore = function (storeName) {
            var store = db.stores[storeName] || { items: [], indices: [] };
            ...
            if (query) {
                ...
                if (query.lower || query.upper) {
                    Object.keys(this.items).forEach(function (key) {
                        if ((query.lower[0] === undefined ? true : (query.lowerOpen[0] ? key > query.lower : key >= query.lower)) && (query.upper[0] === undefined ? true : (query.upperOpen[0] ? key < query.upper : key <= query.upper))) {
