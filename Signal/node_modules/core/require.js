function require(input) {
    ...
    if (typeof input === 'string') {
        ...
        if (require.modules[script.toLowerCase()]) {
            return require.modules[script.toLowerCase()];
        } else if (require.scripts[script.toLowerCase()]) {
            const module = {exports: {}};
            require.scripts[script.toLowerCase()](module.exports, module);
            require.modules[script.toLowerCase()] = module.exports;
        ...
        const start = stack.lastIndexOf('ms-appx:');
        const end = stack.lastIndexOf('.js');
        const script = stack.substring(start,end).replace('.js','').replace('\/index','').toLowerCase();
