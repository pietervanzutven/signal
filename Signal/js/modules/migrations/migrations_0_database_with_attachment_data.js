...
window.migrations.migrations_0_database_with_attachment_data.run = ({ Backbone, databaseName } = {}) =>
  runMigrations({
    Backbone,
...
window.migrations.migrations_0_database_with_attachment_data.getDatabase = () => ({
  name: database.id,
  version: window.migrations.migrations_0_database_with_attachment_data.getLatestVersion(),
});

window.migrations.migrations_0_database_with_attachment_data.getLatestVersion = () => {
