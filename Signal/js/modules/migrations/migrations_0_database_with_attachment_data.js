(function () {
  ...
  window.migrations.migrations_0_database_with_attachment_data.migrations = [
    {
      version: '12.0',
  ...
  const database = {
    id: 'signal',
    nolog: true,
    migrations: window.migrations.migrations_0_database_with_attachment_data.migrations,
  };

  window.migrations.migrations_0_database_with_attachment_data.run = ({ Backbone } = {}) =>
    runMigrations({ Backbone, database });

  window.migrations.migrations_0_database_with_attachment_data.getDatabase = () => ({
    name: database.id,
    version: last(window.migrations.migrations_0_database_with_attachment_data.migrations).version,
  });
})();