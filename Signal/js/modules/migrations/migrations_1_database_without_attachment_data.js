(function () {
    ...
    window.migrations.migrations_1_database_without_attachment_data.run = async ({ Backbone, database } = {}) => {
        const { canRun } = await window.migrations.migrations_1_database_without_attachment_data.getStatus({ database });
        if (!canRun) {
    ...
    window.migrations.migrations_1_database_without_attachment_data.getStatus = async ({ database } = {}) => {
    ...
    window.migrations.migrations_1_database_without_attachment_data.getLatestVersion = () => {
