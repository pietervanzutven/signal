(function () {
    ...
    const mapStateToProps = (state) => {
        return Object.assign({ searchTerm: search_1.getQuery(state), regionCode: user_1.getRegionCode(state), ourNumber: user_1.getUserNumber(state) }, conversations_1.getMe(state), { i18n: user_1.getIntl(state) });
    };
