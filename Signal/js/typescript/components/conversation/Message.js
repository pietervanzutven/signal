(function () {
    ...
    class Message extends react_1.default.Component {
        ...
        renderQuote() {
            ...
            return (react_1.default.createElement(Quote_1.Quote, { i18n: i18n, onClick: quote.onClick, text: quote.text, attachment: quote.attachment, isIncoming: direction === 'incoming', authorPhoneNumber: quote.authorPhoneNumber, authorProfileName: quote.authorProfileName, authorName: quote.authorName, authorColor: quote.authorColor, isFromMe: quote.isFromMe, withContentAbove: withContentAbove }));
        }
