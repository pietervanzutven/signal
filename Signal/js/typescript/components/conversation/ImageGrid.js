        ...
        render() {
            ...
            if (attachments.length === 2) {
                return (react_1.default.createElement("div", { className: "module-image-grid" },
                    ...
                    react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[1], i18n), i18n: i18n, bottomOverlay: withBottomOverlay, noBorder: isSticker, curveTopRight: curveTopRight, curveBottomRight: curveBottomRight, playIconOverlay: Attachment_1.isVideoAttachment(attachments[1]), height: 149, width: 149, attachment: attachments[1], url: Attachment_1.getThumbnailUrl(attachments[1]), onClick: onClick, onError: onError })));
            }
            if (attachments.length === 3) {
                return (react_1.default.createElement("div", { className: "module-image-grid" },
                    react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[0], i18n), i18n: i18n, bottomOverlay: withBottomOverlay, noBorder: isSticker, curveTopLeft: curveTopLeft, curveBottomLeft: curveBottomLeft, attachment: attachments[0], playIconOverlay: Attachment_1.isVideoAttachment(attachments[0]), height: 200, width: 199, url: Attachment_1.getUrl(attachments[0]), onClick: onClick, onError: onError }),
                    react_1.default.createElement("div", { className: "module-image-grid__column" },
                        ...
                        react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[2], i18n), i18n: i18n, bottomOverlay: withBottomOverlay, noBorder: isSticker, curveBottomRight: curveBottomRight, height: 99, width: 99, attachment: attachments[2], playIconOverlay: Attachment_1.isVideoAttachment(attachments[2]), url: Attachment_1.getThumbnailUrl(attachments[2]), onClick: onClick, onError: onError }))));
            }
                ...
                return (react_1.default.createElement("div", { className: "module-image-grid" },
                    react_1.default.createElement("div", { className: "module-image-grid__column" },
                        ...
                        react_1.default.createElement("div", { className: "module-image-grid__row" },
                            ...
                            react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[3], i18n), i18n: i18n, bottomOverlay: withBottomOverlay, noBorder: isSticker, curveBottomRight: curveBottomRight, playIconOverlay: Attachment_1.isVideoAttachment(attachments[3]), height: 149, width: 149, attachment: attachments[3], url: Attachment_1.getThumbnailUrl(attachments[3]), onClick: onClick, onError: onError })))));
            }
