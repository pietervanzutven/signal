(function () {
    ...
    class ImageGrid extends react_1.default.Component {
        ...
        render() {
            const { attachments, bottomOverlay, i18n, isSticker, stickerSize, onError, onClick, tabIndex, withContentAbove, withContentBelow, } = this.props;
            ...
            if (attachments.length === 3) {
                return (react_1.default.createElement("div", { className: "module-image-grid" },
                    ...
                    react_1.default.createElement("div", { className: "module-image-grid__column" },
                        ...
                        react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[2], i18n), i18n: i18n, bottomOverlay: withBottomOverlay, noBorder: false, curveBottomRight: curveBottomRight, height: 99, width: 99, attachment: attachments[2], playIconOverlay: Attachment_1.isVideoAttachment(attachments[2]), url: Attachment_1.getThumbnailUrl(attachments[2]), onClick: onClick, onError: onError }))));
            }
            if (attachments.length === 4) {
                return (react_1.default.createElement("div", { className: "module-image-grid" },
                    react_1.default.createElement("div", { className: "module-image-grid__column" },
                        react_1.default.createElement("div", { className: "module-image-grid__row" },
                            react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[0], i18n), i18n: i18n, curveTopLeft: curveTopLeft, noBorder: false, attachment: attachments[0], playIconOverlay: Attachment_1.isVideoAttachment(attachments[0]), height: 149, width: 149, url: Attachment_1.getThumbnailUrl(attachments[0]), onClick: onClick, onError: onError }),
                        ...
                        react_1.default.createElement("div", { className: "module-image-grid__row" },
                            react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[2], i18n), i18n: i18n, bottomOverlay: withBottomOverlay, noBorder: false, curveBottomLeft: curveBottomLeft, playIconOverlay: Attachment_1.isVideoAttachment(attachments[2]), height: 149, width: 149, attachment: attachments[2], url: Attachment_1.getThumbnailUrl(attachments[2]), onClick: onClick, onError: onError }),
                            react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[3], i18n), i18n: i18n, bottomOverlay: withBottomOverlay, noBorder: false, curveBottomRight: curveBottomRight, playIconOverlay: Attachment_1.isVideoAttachment(attachments[3]), height: 149, width: 149, attachment: attachments[3], url: Attachment_1.getThumbnailUrl(attachments[3]), onClick: onClick, onError: onError })))));
            }
            ...
            return (react_1.default.createElement("div", { className: "module-image-grid" },
                react_1.default.createElement("div", { className: "module-image-grid__column" },
                    ...
                    react_1.default.createElement("div", { className: "module-image-grid__row" },
                        react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[2], i18n), i18n: i18n, bottomOverlay: withBottomOverlay, noBorder: isSticker, curveBottomLeft: curveBottomLeft, playIconOverlay: Attachment_1.isVideoAttachment(attachments[2]), height: 99, width: 99, attachment: attachments[2], url: Attachment_1.getThumbnailUrl(attachments[2]), onClick: onClick, onError: onError }),
                        react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[3], i18n), i18n: i18n, bottomOverlay: withBottomOverlay, noBorder: isSticker, playIconOverlay: Attachment_1.isVideoAttachment(attachments[3]), height: 99, width: 98, attachment: attachments[3], url: Attachment_1.getThumbnailUrl(attachments[3]), onClick: onClick, onError: onError }),
                        react_1.default.createElement(Image_1.Image, { alt: Attachment_1.getAlt(attachments[4], i18n), i18n: i18n, bottomOverlay: withBottomOverlay, noBorder: isSticker, curveBottomRight: curveBottomRight, playIconOverlay: Attachment_1.isVideoAttachment(attachments[4]), height: 99, width: 99, darkOverlay: moreMessagesOverlay, overlayText: moreMessagesOverlayText, attachment: attachments[4], url: Attachment_1.getThumbnailUrl(attachments[4]), onClick: onClick, onError: onError })))));
        }
    }
