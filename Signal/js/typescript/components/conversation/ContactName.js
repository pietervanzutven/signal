    ...
    class ContactName extends react_1.default.Component {
        render() {
            ...
            const fragment = (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                profileElement));
            return (react_1.default.createElement("span", { className: prefix, dir: "auto" }, isMe ? (react_1.default.createElement(Intl_1.Intl, { i18n: i18n, id: "ContactName--you", components: [fragment] })) : (fragment)));
        }
    }
