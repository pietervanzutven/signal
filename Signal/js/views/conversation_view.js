  ...
  Whisper.ConversationView = Whisper.View.extend({
    ...
    getPropsForAttachmentList() {
      ...
      return {
        ...
        attachments: draftAttachments.map(attachment => (Object.assign({},
          attachment,
          {
    ...
    async sendStickerMessage(options = {}) {
      try {
        ...
        if (contacts && contacts.length) {
          ...
          if (sendAnyway) {
            this.sendStickerMessage(Object.assign({}, options, { force: true }));
          }
    ...
    async makeChunkedRequest(url) {
      ...
      const firstChunk = Object.assign({},
        {
          start: 0,
          end: initialOffset,
        },
