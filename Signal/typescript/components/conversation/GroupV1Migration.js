    ...
    function GroupV1Migration(props) {
        ...
        return (React.createElement("div", { className: "module-group-v1-migration" },
            ...
            showingDialog ? (React.createElement(ModalHost_1.ModalHost, { onClose: dismissDialog },
                React.createElement(GroupV1MigrationDialog_1.GroupV1MigrationDialog, { areWeInvited: areWeInvited, droppedMembers: droppedMembers, hasMigrated: true, i18n: i18n, invitedMembers: invitedMembers, migrate: () => window.log.warn('GroupV1Migration: Modal called migrate()'), onClose: dismissDialog }))) : null));
    }
