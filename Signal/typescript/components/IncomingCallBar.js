require(exports => {
    ...
    const CallButton = ({ classSuffix, onClick, tabIndex, tooltipContent, }) => {
        return (react_1.default.createElement("button", { className: `module-incoming-call__icon module-incoming-call__button--${classSuffix}`, onClick: onClick, tabIndex: tabIndex },
