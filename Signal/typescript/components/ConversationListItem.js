(function () {
    ...
    class ConversationListItem extends react_1.default.PureComponent {
        ...
        renderMessage() {
            const { draftPreview, i18n, acceptedMessageRequest, lastMessage, muteExpiresAt, shouldShowDraft, typingContact, unreadCount, } = this.props;
